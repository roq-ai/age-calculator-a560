  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Discover your precise age with Age Calculator, your reliable tool for calculating age based on your date of birth."
        />
      </Head>
      ...
      <Stack minH={'100vh'} direction={{ base: 'column', md: 'row' }}>
        <Flex p={8} flex={1} align={'center'} justify={'center'}>
          <Stack position="relative" spacing={6} w={'full'} maxW={'lg'}>
            ...
            <Text fontSize={{ base: 'md', lg: 'lg' }} color={'gray.500'}>
              {`Discover your precise age with Age Calculator, your reliable tool for calculating age based on your date of birth.`}
            </Text>
        ...
        <Flex position="relative" flex={1}>
          <Image
            src={
              'https://images.unsplash.com/photo-1504270997636-07ddfbd48945?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxhZ2UlMkNjYWxjdWxhdG9yfGVufDB8fHx8MTY4ODA1MDkxMnww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt={'Login Image'}
            objectFit={'cover'}
          />
